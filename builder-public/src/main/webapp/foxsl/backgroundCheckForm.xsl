...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="backgroundCheckForm">
		...
		<fo:block margin-top="5mm">
         ...
         <!-- 48682 DocuSign Feature END -->
			<fo:block font-family="Arial" font-size="9px" margin-top="10mm">
				...
				<fo:inline font-weight="bold"><xsl:value-of select="response/companyname"/></fo:inline> Individual/Broker and complying with any applicable state and/or federal law.
			</fo:block>
					...
					<fo:table-body>
						<fo:table-row height="5mm">
							...
							<fo:table-cell>
								<fo:block>Date : &#160;&#160;&#160; 
									<fo:inline text-decoration="underline" font-weight="bold" font-size="10px">
										<fo:inline color="white"  >
											<fo:block><xsl:value-of select="response/DATE_IDENTIFIER"/></fo:block>
										 </fo:inline>
									 </fo:inline>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row height="5mm">
							...
							<fo:table-cell number-columns-spanned="2">
								<fo:block><xsl:value-of select="response/printname"/></fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row height="5mm">
							<fo:table-cell>
							...
							<fo:table-cell number-columns-spanned="2">
								<fo:block><xsl:value-of select="response/companyname"/></fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
				</fo:table>		
