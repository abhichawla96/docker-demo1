					...
					<fo:table-body>
						<fo:table-row>
							...
							<xsl:if test="response/registration_type_code='PRAG' or response/registration_type_code='SCAG'">
								...
								<fo:block font-size="12px" font-family="Arial"
									font-weight="bold" text-align="center">PRODUCER DATA SHEET</fo:block>
									</xsl:if>
									</fo:block>
							</fo:table-cell>
						</fo:table-row>
													...
													<fo:table-body>
														<fo:table-row border="0.0pt solid black"
															...
															<xsl:if test="response/registration_type_code='PRAG' or response/registration_type_code='SCAG'">
																...
																<xsl:if test="response/registration_type_code='PRERG'">
																<fo:block font-size="8px" font-family="Arial"
																	font-weight="bold" text-decoration="underline">Agency Information
																</fo:block>
																</xsl:if>
																</fo:block>
															</fo:table-cell>
														...
														<fo:table-row border="0.0pt solid black"
															...
															<xsl:if test="response/registration_type_code='PRAG' or response/registration_type_code='SCAG'">
																...
																<fo:block font-size="8px" font-family="Arial"
																	>
																	<xsl:value-of select="response/aar_agencyname"></xsl:value-of>,
																	#<xsl:value-of select="response/producer_number"></xsl:value-of>
																</fo:block>
																</xsl:if>
																</fo:block>
															</fo:table-cell>
													...
													<fo:table-body>
														<fo:table-row border="0.0pt solid black"
															...
															<fo:table-cell border="0.0pt solid black" width="1.8in">
																<xsl:if test="member_of_hba1='N'">
																<fo:block font-size="8px" font-family="Arial">
																	No
																</fo:block>
																</xsl:if>
																<xsl:if test="member_of_hba1='Y'">
																<fo:block font-size="8px" font-family="Arial">
																	Yes
																</fo:block>
																</xsl:if>
												...
												<fo:table border="0.0pt solid black">
													...
													<fo:table-body>
														<fo:table-row border="0.0pt solid black"
															height="5mm">
															<fo:table-cell border="0.0pt solid black">
																<fo:block font-size="8px" font-family="Arial">Agency Address:
																	</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
											...
											<fo:table-cell border="0.0pt solid black" padding-bottom="-3mm">
												<fo:table border="0.0pt solid black">
													...
													<fo:table-body>
														<fo:table-row border="0.0pt solid black"
															height="5mm">
															<fo:table-cell border="0.0pt solid black" width="5.0in">
																<fo:block font-size="8px" font-family="Arial"
																	>
																	<xsl:value-of select="response/address1"></xsl:value-of>,
																	 <xsl:if test="response/address2 !='' ">
																	 	<xsl:value-of select="concat(response/address2,',')"></xsl:value-of>
																	 </xsl:if>
																	  <xsl:text> </xsl:text>
																	  <xsl:value-of select="response/city"></xsl:value-of>,
																	  <xsl:text> </xsl:text>
																	  <xsl:value-of select="response/statecode"></xsl:value-of>
																	  <xsl:text> </xsl:text>
																	 <xsl:value-of select="response/zip"></xsl:value-of>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
...
<xsl:if test="response/isHideAltPhone='N'">
			...
			<fo:block margin-top="1mm">
				<fo:table border="1.0pt solid black" width="100%">
					<fo:table-column border="1.0pt solid black"/>
					<fo:table-column border="1.0pt solid black"/>
					
					<fo:table-body>
					    <xsl:if test="response/agencyListPublicSubmitNInvitationEdit_list_1/data !='' ">
						<xsl:for-each select="response/agencyListPublicSubmitNInvitationEdit_list_1/data[1]">
							<fo:table-row border="1.0pt solid black">
								<fo:table-cell 
									padding-top="3px" padding-bottom="3px" width="200pt">
									<fo:block font-size="8px" font-family="Arial"
										text-align="center">
										First Name
									</fo:block>
								...
								<fo:table-cell  
									...
									<fo:block font-size="8px" font-family="Arial" text-align="center">
										Last Name
									</fo:block>
								</fo:table-cell>
								<fo:table-cell  
							...
							<fo:table-cell 
								...
								<fo:table-cell 
									...
									<fo:block font-size="8px" font-family="Arial"
										...
										<xsl:value-of select="concat(addressline2,',')"></xsl:value-of>
										</xsl:if>
										<xsl:text> </xsl:text>
								...
								<fo:table-row border="1.0pt solid black">
								<fo:table-cell padding-top="3px" padding-bottom="3px" >
									<fo:block font-size="8px" font-family="Arial" text-align="center">
									Email address
									</fo:block>
								</fo:table-cell>
					...
					<fo:table-row border="1.0pt solid black">
						<fo:table-cell border="0.0pt solid black"
							...
							<fo:block font-size="8px" font-family="Arial">Policy
								Limit : </fo:block>
								<fo:block font-size="8px" font-family="Arial">SIR : </fo:block>
						...
						<fo:table-cell border="1.0pt solid black"
							...
							<fo:block font-size="8px" font-family="Arial">
								<xsl:value-of select="response/self_insured_retention" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="1.0pt solid black"
							>
							...
							<fo:block font-size="8px" font-family="Arial">Deductible :	 </fo:block>
						</fo:table-cell>
						<fo:table-cell border="1.0pt solid black"
							>
							<fo:block font-size="8px" font-family="Arial">
							...
							<fo:block font-size="8px" font-family="Arial">
								<xsl:value-of select="response/deductible" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="1.0pt solid black"
							>
				...
				<fo:table-body>
					<fo:table-row border="1.0pt solid black">
						...
						<fo:table-cell border="1.0pt solid black"
							...
							<fo:block font-size="8px" font-family="Arial">
								<xsl:value-of select="response/cyber_liability_self_insured_retention" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="1.0pt solid black"
							>
						...
						<fo:table-cell border="1.0pt solid black"
							...
							<fo:block font-size="8px" font-family="Arial">
								<xsl:value-of select="response/cyber_liability_deductible" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="1.0pt solid black"
							>
...
<xsl:if test="response/registration_type_code='PRAG' or response/registration_type_code='SCAG'">
							...
							<fo:table border="1.0pt solid black">
								...
								<fo:table-body>
									<fo:table-row border="1.0pt solid black">
										...
										<fo:table-cell width="230pt" border="1.0pt solid black"
											padding-start="5px" padding-top="3px" padding-bottom="3px">
											<fo:block font-size="8px" font-family="Arial"
		...
		<xsl:if test="response/signature_acceptance_security='Y' and response/registration_type_code='PRAG' or response/registration_type_code='SCAG'">
			<fo:block break-after="page"></fo:block>
			<fo:block margin-top="5mm">
						...
						<fo:table-row>
							...
							<fo:table-cell number-columns-spanned="2">
								<fo:block font-size="10px">
									...
									<!-- CUSTOM_TAB_IDENTFIER_CUSTOMTITLE -->
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row>
		...
		<xsl:if test="response/signature_acceptance_security='Y' and response/registration_type_code='PRERG'">
